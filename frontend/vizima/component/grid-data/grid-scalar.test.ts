...
import { GridScalar, type GridScalarProps } from "./grid-scalar"; // Update this path
...
describe("GridScalarData", () => {
    ...
    const scalarGrid = new GridScalar(defaultProps, gridData);
    ...
    describe("get()", () => {
        ...
        it("should not return NaN for value 0", () => {
            ...
            const sparseGrid = new GridScalar(defaultProps, sparseData);
    ...
    describe("interpolateNearest()", () => {
        ...
        it("should interpolate correctly in between 360 to 0 for periodic lon", () => {
            ...
            const wrapGrid = new GridScalar(props, gridData)
            ...
            expect(wrapGrid.interpolateNearest(355, 0)).toBe(10);
        });
        ...
        it("should interpolate correctly in between 180 to -180 periodic lon", () => {
            ...
            expect(wrapGrid.interpolateNearest(170, 0)).toBe(10);
        });
    });
    ...
    describe("interpolateBilinear()", () => {
        ...
        it("should return NaN if any corner is NaN", () => {
            ...
            const nanGrid = new GridScalar(defaultProps, nanData);
